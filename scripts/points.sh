...
sh ./scripts/experiment.sh kubernetes 1 2 50 e1/1e6-2-rw
# running experiment 1 clients and 4 threads with a read rate of 50%
sh ./scripts/experiment.sh kubernetes 1 4 50 e1/1e6-2-rw
# running experiment 1 clients and 8 threads with a read rate of 50%
sh ./scripts/experiment.sh kubernetes 1 8 50 e1/1e6-2-rw
# running experiment 2 clients and 4 threads with a read rate of 50%
sh ./scripts/experiment.sh kubernetes 2 4 50 e1/1e6-2-rw
# running experiment 1 clients and 16 threads with a read rate of 50%
sh ./scripts/experiment.sh kubernetes 1 16 50 e1/1e6-2-rw
